...
export default async function CustomerCreditDetailPage({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-10">
      <Link href="/perfil/creditos" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700">
      ...
      <div className="card overflow-hidden">
        ...
        <div className="space-y-4 p-4">
          {plan.scheduleItems.map((installment) => {
            ...
            return (
              <div key={installment.id} className="rounded-2xl border border-gray-100 bg-gray-50/70 p-4">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div className="space-y-2">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-sm font-bold text-gray-900">Cuota #{installment.sequence}</span>
