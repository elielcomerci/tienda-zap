  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Orden #{orderCode}</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="card p-5">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-xs text-gray-500 mb-1">Metodo de pago</p>
              ...
              {order.receiptUrl && (
                <a href={order.receiptUrl} target="_blank" rel="noreferrer" className="btn-secondary w-full justify-center !text-xs !py-2 mt-2">
                    ...
                    <div className="flex-1">
                      ...
                      {item.selectedOptions && item.selectedOptions.length > 0 && (
                        <p className="text-xs text-gray-500 mb-1 font-medium">
                          {item.selectedOptions.map((option: any) => option.valueName).join(' • ')}
                        </p>
                      )}
