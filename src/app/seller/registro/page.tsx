  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-orange-100">
        <div className="p-8 pb-6 bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900/50 text-white text-center relative overflow-hidden">
        ...
        <form action={registerSeller} className="p-8 pt-6 space-y-4">
          ...
          <div>
            <label className="label">
              Documento (DNI/CUIT) <span className="text-gray-400 font-normal">(requerido)</span>
            </label>
            <input name="documentId" type="text" required className="input" placeholder="DNI o CUIT para pagos" />
          </div>
