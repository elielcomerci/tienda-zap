...
export default function CheckoutZapCreditConfigurator({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl border border-[#F66B9A]/25 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="rounded-2xl border border-[#F66B9A]/15 bg-[#FEF1F6] px-4 py-3 lg:min-w-[220px] lg:text-right">
            <p className="text-xs font-semibold uppercase tracking-wide text-[#C91F5B]">
              Anticipo minimo estimado
            </p>
            <p className="mt-1 text-2xl font-black text-[#ED2C71]">
              ${minimumDownPaymentAmount.toLocaleString('es-AR')}
            </p>
            <p className="text-xs text-[#C91F5B]">{minimumDownPaymentPercent}% del pedido</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-gray-100 bg-gray-50/80 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#F66B9A]/25 bg-white px-4 py-2.5 text-sm font-semibold text-[#C91F5B] transition-colors hover:border-orange-300 hover:bg-[#FEF1F6]"
          >
        ...
        {showAdvanced && (
          <div className="mt-5 space-y-4">
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
              <div className="rounded-2xl border border-gray-100 bg-gray-50/80 p-4">
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  <Repeat size={15} className="text-[#ED2C71]" />
                  Frecuencia de pago
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-xl border px-3 py-3 text-sm font-semibold transition-colors ${
                          selected
                            ? 'border-orange-400 bg-[#FEF1F6] text-[#C91F5B]'
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50/80 p-4">
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  <CreditCard size={15} className="text-[#ED2C71]" />
                  Cantidad de pagos
                </div>
            ...
            <div className="rounded-2xl border border-[#F66B9A]/15 bg-[#FEF1F6]/70 p-4">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-[#C91F5B]">
                <Gauge size={15} />
                Regla simple
              </div>
              <p className="mt-2 text-sm text-[#C91F5B]">
